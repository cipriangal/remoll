...
void yield_counts_asymmetry_window(TString runtype){

	TString name_rootfile_up="/home/yxzhao/Contamination/analysis/generate_plots/rootfiles/remoll_"+runtype+"_up.root";
	TString name_rootfile_down="/home/yxzhao/Contamination/analysis/generate_plots/rootfiles/remoll_"+runtype+"_down.root";
	...
	T->AddFile(name_rootfile_up);
	T->AddFile(name_rootfile_down);
